...
Generated by Repomix on: 2025-02-09T14:43:50.411Z
...
- Only files matching these patterns are included: src/api/**/*.js, src/engine/**/*.js, src/processors/base/**/*.js, src/processors/flow/**/*.js, src/processors/util/**/*.js, src/utils/**/*.js, src/applications/string-pipeline/**/*, src/applications/file-pipeline/**/*, src/applications/test_fork/**/*, package.json, README.md, run.js
- Files matching these patterns are excluded: .env, .git, **/_*, node_modules, *.log, docs, **/*repopack*.txt, **/*.html, **/data/*, **/*copy.js, **/conversations.json
...
================
{
  ...
  "scripts": {
    ...
    "rp": "node --no-warnings $(which repomix) -c config/repomix.config-small.json . && node --no-warnings $(which repomix) -c config/repomix.config-large.json . && node --no-warnings $(which repomix) -c config/repomix.config-docs.json .",
    "watch": "webpack --watch",
    "serve": "webpack serve"
  },
  "nyc": {
