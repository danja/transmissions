...
describe('fs-rw simple test', function () {
    ...
    const outputFile = path.join(rootDir, 'src/apps/test_fs-rw/data/output/output-01.md')
    const requiredFile = path.join(rootDir, 'src/apps/test_fs-rw/data/output/required-01.md')
    ...
    it('should process file correctly', async () => {
        ...
        await import('../../../src/apps/_pending/test_fs-rw/simple.js')
